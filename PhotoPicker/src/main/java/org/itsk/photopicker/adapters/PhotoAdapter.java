package org.itsk.photopicker.adapters;
...
import org.itsk.photopicker.R;
import org.itsk.photopicker.beans.Photo;
import org.itsk.photopicker.utils.ImageLoader;
...
public class PhotoAdapter extends BaseAdapter {
    ...
    public PhotoAdapter(Context context, List<Photo> mDatas,List<String> selectedPhotos) {
        this.mDatas = mDatas;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(getItemViewType(position) == TYPE_CAMERA) {
            ...
            ImageLoader.getInstance(mContext.getApplicationContext()).display(photo.getPath(), holder.photoImageView,
                    mWidth, mWidth);
        }
        return convertView;
    }
